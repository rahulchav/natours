    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            console.log(email, "".concat(password));
            _context.prev = 1;
            _context.next = 4;
...
},{"axios":"../../node_modules/axios/index.js","./alert":"alert.js"}],"updateSetttings.js":[function(require,module,exports) {
"use strict";
...
var stripe = Stripe('pk_test_51LCirDSDuYJC9SQShxRtBmNwYw7ErlHiBYJ4yPTyDAxqogX4YtQkIgWNLf06ZKuZj7Az7ZM6BjkVTKfa29IGqWup00QccB7OJB');
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            console.log(session); // 2 create checkut forn + change credit card
...
var _updateSetttings = require("./updateSetttings");
...
if (logoutBtn) logoutBtn.addEventListener('click', _script.logout);
...
if (loginForm) {
  loginForm.addEventListener('submit', function (e) {
    ...
    (0, _script.login)(email, password);
  });
...
if (userDataForm) userDataForm.addEventListener('submit', function (e) {
  ...
  console.log(form);
  (0, _updateSetttings.updateSettings)(form, 'data');
});
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            _context.next = 7;
            return (0, _updateSetttings.updateSettings)({
